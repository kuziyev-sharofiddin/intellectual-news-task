    ...
    <div class="page">
        <div class="container">
            <div class="breadcrumb"><a href="https://ipcenter.uz/" class=""><span>Asosiy sahifa</span></a>
                ...
                <a aria-current="page" href="https://ipcenter.uz/history"
                ...
                <a aria-current="page" href="https://ipcenter.uz/history"
                   class="router-link-active router-link-exact-active"><span>Markaz tarixi</span></a></div>
            <h1>{{$page->title}}</h1>
            <div class="page-wrapper">
                <div glutter="0,0" class="ant-row css-16pw25h">
                    <div class="ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-24 ant-col-lg-24 ant-col-xl-18 ant-col-xxl-19 css-16pw25h">
                        <div class="page-main">
                            <div class="pages-history">
                                <div class="pages-history-wrapper">
                                    <div class="ant-row css-16pw25h">
                                        <div class="ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-16 ant-col-lg-12 ant-col-xl-14 ant-col-xxl-14 css-16pw25h">
                                            <div class="pages-history-content" style="text-align: justify; ">
                                                {!! $page->description !!}
                                            </div>
                                        </div>
                                        <div class="ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-8 ant-col-lg-12 ant-col-xl-10 ant-col-xxl-10 css-16pw25h">
                                            <div class="pages-history-img"><img
                    ...
                    <div class="ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-24 ant-col-lg-24 ant-col-xl-6 ant-col-xxl-5 css-16pw25h">
                        <div class="page-sidebar">
                            <div class="page-sidebar-menu"><h4>Markaz haqida</h4>
                                <ul>
                                    <li><a aria-current="page" href="https://ipcenter.uz/history"
                                           class="router-link-active router-link-exact-active parent"><span></span>
                                            <!----></a><!----></li>
